<template>
    <div class="w-full flex justify-end">
        <button type="button" @click="addTaskHandler" class="p-2 m-2 bg-indigo-500 rounded-2xl text-white px-6 py-4 cursor-pointer">Add Task</button>
    </div>
    ...
    <div>
        <AddTaskForm :showPopup="showPopup"  @togglePopup="togglePopup" :newTask="newTask" @saveTask="saveTask" />
    </div>
...
{
    name:"Task 2",
    description:"Lorem ipsum is a dummy or placeholder text commonly used in graphic design, publishing, and web development. 2",
    completed:true,
    id:2
},
{
